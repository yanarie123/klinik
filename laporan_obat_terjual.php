...
<form action="<?php $_SERVER ['PHP_SELF'];?>" method="post" name="form1" target="_self">
  <table width="500" border="0"  class="table-list">
    <tr>
      <td colspan="3" bgcolor="#CCCCCC"><strong>PERIODE OBAT TERJUAL </strong></td>
    </tr>
    <tr>
...
<table class="table-list" width="751" border="0" cellspacing="1" cellpadding="2">
  <tr>
    <td colspan="6">&nbsp;</td>
    <td align="center" >&nbsp;</td>
    <td align="center" ><a href="export_laporan_obat_terjual.php"><img src="images/excel.png" width="30" height="30" border="0" /></a></td>
  </tr>
  <tr>
    <td width="30" align="center" bgcolor="#F5F5F5"><b>No</b></td>
    <td width="78" bgcolor="#F5F5F5"><strong>No. Penjualan</strong></td>
    <td width="91" bgcolor="#F5F5F5"><strong>Tgl. Penjualan </strong></td>
    <td width="45" bgcolor="#F5F5F5"><strong>Kode</strong></td>
    <td width="250" align="right" bgcolor="#F5F5F5"><div align="left"><strong><b>Nama Obat</b></strong></div></td>
    <td width="93" align="right" bgcolor="#F5F5F5"><b> Harga (Rp) </b></td>
    <td width="61" align="center" bgcolor="#F5F5F5"><b> Jumlah </b></td>
    <td width="62" align="center" bgcolor="#F5F5F5"><strong>Stock</strong></td>
  </tr>
  <?php
	// SQL menampilkan item obat yang dijual
	$mySql ="SELECT penjualan_item.*, obat.nm_obat, penjualan.no_penjualan FROM penjualan_item
			  INNER JOIN obat ON penjualan_item.kd_obat=obat.kd_obat
