...
if(isset($_POST['btnSimpan'])){
	...
	$cekSql="SELECT * FROM tindakan WHERE nm_tindakan='$txtNama'
			AND NOT (nm_tindakan='".$_POST['txtLama']."')";
	...
	if (count($pesanError)>=1 ){
		...
		$mySql	= "UPDATE tindakan SET nm_tindakan='$txtNama',
					harga='$txtHarga'
...
$myQry = mysql_query ($mySql, $koneksidb) or die ("Query ambil data salah : ".mysql.error());
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self" id="form1">
  <table width="100%" class="table-list" border="0" cellpadding="4" cellspacing="1">
    ...
    <tr>
      ...
      <input name="txtLama" type="hidden" id="txtLama" /></td>
    </tr>
    <tr>
